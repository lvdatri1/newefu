...
COUNTRY_OPTIONS = [
    ...
    selector.SelectOptionDict(value="NZ", label="New Zealand"),
    ...
    selector.SelectOptionDict(value="KR", label="South Korea"),
    selector.SelectOptionDict(value="SG", label="Singapore"),
    selector.SelectOptionDict(value="MY", label="Malaysia"),
    selector.SelectOptionDict(value="TH", label="Thailand"),
    selector.SelectOptionDict(value="IN", label="India"),
    selector.SelectOptionDict(value="BR", label="Brazil"),
    selector.SelectOptionDict(value="MX", label="Mexico"),
    selector.SelectOptionDict(value="ZA", label="South Africa"),
    selector.SelectOptionDict(value="AE", label="United Arab Emirates"),
    selector.SelectOptionDict(value="SA", label="Saudi Arabia"),
    selector.SelectOptionDict(value="RU", label="Russia"),
